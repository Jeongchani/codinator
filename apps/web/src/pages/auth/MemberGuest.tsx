...
const MemberGuest: React.FC = () => {
  ...
  const handleGuestClick = () => navigate('/rankingZone');
  ...
  return (
    <div className={styles.container}>
      <button
        ...
        className="absolute top-3 left-3 z-50 rounded-full bg-neutral-900 px-3 py-1.5 text-xs text-white transition-all active:scale-95"
      >
        TestPage
      </button>
